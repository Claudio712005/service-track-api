...
class ClienteIT {
    ...
    fun setup() {
        ...
        given()
            ...
            .post("/mecanicos")
        tokenCliente = TokenTeste.para("cliente.busca.it@email.com")
        clienteId    = TokenTeste.idDe("cliente.busca.it@email.com")

        tokenMecanico = TokenTeste.para("mecanico.cliente.it@email.com")
    }
