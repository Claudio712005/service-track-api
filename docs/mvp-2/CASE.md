...
Tech Challenge é o projeto da fase que englobará os conhecimentos obtidos em todas as disciplinas da fase. Esta é uma atividade que, em princípio, deve ser desenvolvida em grupo.

> **Importante:** atente-se ao prazo de entrega. Trata-se de uma atividade obrigatória, uma vez que vale **60% da nota** de todas as disciplinas da fase.
...
- Link do repositório GitHub compartilhado com o usuário **soat-architecture**;
- Desenho da arquitetura com os recursos escolhidos;
- Link do vídeo (com até 15 minutos de duração) apresentando a solução desenvolvida.
